    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/20">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-10" aria-label="Dashboard main content">
        ...
        >
          ...
          >
            <div className="bg-gradient-to-br from-white via-blue-50/20 to-indigo-50/20 rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 border border-gray-200/50 backdrop-blur-sm hover:shadow-3xl transition-shadow duration-300">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4 sm:mb-6">
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 flex items-center gap-2 sm:gap-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
                    <HiClock className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white" />
                  </div>
                  <span>Daily Goals</span>
                </h2>
                <div className="px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
              ...
              <div className="space-y-3 sm:space-y-4">
                {dailyGoals.map((goal, index) => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.02, x: 4, boxShadow: "0 10px 30px rgba(59, 130, 246, 0.15)" }}
                    className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-gradient-to-r from-gray-50 to-blue-50/30 border border-gray-200/50 hover:border-blue-400 transition-all duration-300 cursor-pointer"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                        ...
                        <span className="text-xs sm:text-sm font-bold text-gray-600 ml-2 flex-shrink-0">{goal.progress}%</span>
                      </div>
          ...
          >
            <div className="bg-gradient-to-br from-white via-amber-50/20 to-orange-50/20 rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 border border-gray-200/50 backdrop-blur-sm hover:shadow-3xl transition-shadow duration-300">
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center shadow-lg">
                  <HiStar className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white" />
                </div>
                ...
                {achievements.map((achievement, index) => (
                  <motion.div
                    ...
                    whileHover={{ 
                      ...
                      boxShadow: achievement.earned ? "0 20px 40px rgba(99, 102, 241, 0.3)" : "0 10px 20px rgba(0, 0, 0, 0.1)"
                    }}
                    whileTap={{ scale: 0.95 }}
                    className={`p-3 sm:p-4 md:p-5 lg:p-6 rounded-lg sm:rounded-xl border-2 transition-all duration-300 cursor-pointer ${
                      achievement.earned 
                        ? 'bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border-blue-400 shadow-lg hover:shadow-2xl' 
                    ...
                    {achievement.earned && (
                      <div className="flex justify-center mt-1.5 sm:mt-2">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-green-500 flex items-center justify-center shadow-md">
                          <HiCheckCircle className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                        </div>
                      </div>
                    )}
                  </motion.div>
          ...
          <section aria-label="Recent activity">
            ...
            <div className="bg-gradient-to-br from-white via-slate-50/20 to-blue-50/20 rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 border border-gray-200/50 backdrop-blur-sm hover:shadow-3xl transition-shadow duration-300">
              ...
              <motion.button
                ...
                className="mt-4 sm:mt-6 w-full py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-2xl hover:shadow-blue-500/30 min-h-[44px] relative overflow-hidden group"
              ...
              >
                ...
                >
                  <HiArrowRight className="w-4 h-4 sm:w-5 sm:h-5 relative z-10" />
                </motion.div>
              </motion.button>
            </div>
          </section>
          ...
          >
            <div className="relative bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 text-center text-white overflow-hidden border border-slate-700/50">
              {/* Background decoration */}
              <div className="absolute inset-0 opacity-20">
                <div className="absolute top-0 right-0 w-64 h-64 sm:w-96 sm:h-96 bg-blue-500 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-64 h-64 sm:w-96 sm:h-96 bg-purple-500 rounded-full blur-3xl"></div>
              </div>
              ...
              <div className="relative z-10">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-2.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg mb-4 sm:mb-6 shadow-lg"
                >
                  <HiFire className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-400" />
                  <span className="text-xs sm:text-sm font-bold">{stats.streak} Day Streak!</span>
                </motion.div>
                ...
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/80 mb-6 sm:mb-8 md:mb-10 max-w-3xl mx-auto px-2 sm:px-4">
                ...
                <motion.button
                  ...
                  className="w-full sm:w-auto px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 bg-white text-blue-600 font-bold rounded-lg sm:rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-white/50 text-sm sm:text-base md:text-lg flex items-center justify-center gap-2 sm:gap-3 mx-auto min-h-[44px]"
