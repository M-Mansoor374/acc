...
const supportHighlights = [
  {
    ...
    cta: 'Book a Session',
    href: 'mailto:coaches@acceptopia.com?subject=1:1 Coaching Session Request&body=Hi, I would like to book a 1:1 coaching session. Please let me know available times.%0D%0A%0D%0AThank you!',
  },
  {
    id: 'desk',
    ...
    cta: 'Email Support',
    href: 'mailto:support@acceptopia.com?subject=Support Request&body=Hi Acceptopia Support Team,%0D%0A%0D%0AI need help with:%0D%0A%0D%0A[Please describe your issue here]%0D%0A%0D%0AThank you!',
  },
  {
    id: 'community',
    ...
    cta: 'Join Discord',
    href: 'https://discord.gg/acceptopia',
  },
];
            ...
            <div className="mx-auto flex max-w-6xl flex-col gap-8 sm:gap-10 md:gap-12 lg:flex-row lg:items-center">
              ...
              >
                <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-7">
                  ...
                  {(() => {
                    const CommunityIcon = supportHighlights[2].icon;
                    return (
                      <a
                        href={supportHighlights[2].href}
                        target="_blank"
                      ...
                      >
                        ...
                        <div className="relative flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                          <span className="inline-flex h-10 w-10 sm:h-11 sm:w-11 md:h-12 md:w-12 items-center justify-center rounded-2xl sm:rounded-3xl bg-white/20 text-white shadow-lg shadow-indigo-900/40 backdrop-blur flex-shrink-0">
                            <CommunityIcon className="h-5 w-5 sm:h-6 sm:w-6" />
                          </span>
                          <div className="space-y-0.5 sm:space-y-1 min-w-0 flex-1">
                            <p className={`text-xs sm:text-sm font-semibold text-white ${headingFont}`}>{supportHighlights[2].title}</p>
                            <p className="text-[11px] sm:text-xs text-slate-100 leading-relaxed">{supportHighlights[2].description}</p>
                          </div>
                        </div>
                        <span className="relative inline-flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 overflow-hidden rounded-full bg-white/90 px-4 sm:px-5 py-2 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.2em] sm:tracking-[0.28em] md:tracking-[0.32em] text-slate-900 shadow-lg shadow-black/20 transition-all duration-300 group-hover:-translate-y-0.5 group-hover:shadow-xl whitespace-nowrap self-stretch sm:self-auto">
                          ...
                          <span className="relative">{supportHighlights[2].cta}</span>
