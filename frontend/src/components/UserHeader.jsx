...
const authedNavLinks = [
  ...
  { id: 'friends-group', label: 'Group', path: '/group' },
];
  ...
  return (
    ...
    <motion.header
      ...
      className={`sticky top-0 z-50 w-full border-b transition-all duration-500 ${
        isScrolled
          ? 'border-sky-200/50 bg-white/95 backdrop-blur-xl shadow-xl shadow-sky-500/10'
    ...
    {/* Mobile Menu Portal - Outside header for proper z-index stacking */}
    <AnimatePresence>
      {isMobileMenuOpen && (
        <motion.div
        ...
        >
              ...
              />
              <motion.aside
                className="absolute right-0 top-0 flex h-full w-full max-w-xs flex-col bg-white text-slate-700 shadow-2xl shadow-sky-200/70 overflow-hidden"
                initial={{ x: '100%' }}
                animate={{ x: 0 }}
                exit={{ x: '100%' }}
              ...
              >
                ...
                <div className="flex flex-1 flex-col min-h-0 overflow-hidden">
                  ...
                  <div className="flex-1 overflow-y-auto overflow-x-hidden px-5 py-6" style={{ WebkitOverflowScrolling: 'touch' }}>
                    <div className="flex flex-col gap-3">
                      ...
                      {/* Group */}
                      <Link to="/group" onClick={handleLinkClick} className="w-full">
                        <motion.button
                          initial={{ opacity: 0, x: 24 }}
                          animate={{ opacity: 1, x: 0 }}
                  ...
                  <div className="flex-shrink-0 p-5 border-t border-sky-200 bg-sky-50/50">
                    {/* Logout Button */}
                    <motion.button
...
const UserHeader = memo(LoginHeaderComponent);
