                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <motion.div
                        ...
                        className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 flex items-center justify-center shadow-lg shadow-blue-500/50 mb-2 sm:mb-3"
                      >
                        <HiUsers className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                      </motion.div>
                      <p className="text-[10px] sm:text-xs md:text-sm font-medium text-white/70 mb-1 sm:mb-1.5">Total Users</p>
                      <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-300 to-indigo-300 bg-clip-text text-transparent leading-tight">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <motion.div
                        ...
                        className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-purple-500 via-pink-500 to-rose-500 flex items-center justify-center shadow-lg shadow-purple-500/50 mb-2 sm:mb-3"
                      >
                        <HiLightningBolt className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                      </motion.div>
                      <p className="text-[10px] sm:text-xs md:text-sm font-medium text-white/70 mb-1 sm:mb-1.5">Total Simulations</p>
                      <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent leading-tight">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <motion.div
                        ...
                        className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-emerald-500/50 mb-2 sm:mb-3"
                      >
                        <HiBookOpen className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                      </motion.div>
                      <p className="text-[10px] sm:text-xs md:text-sm font-medium text-white/70 mb-1 sm:mb-1.5">Total Resources</p>
                      <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-emerald-300 to-teal-300 bg-clip-text text-transparent leading-tight">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <motion.div
                        ...
                        className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 flex items-center justify-center shadow-lg shadow-amber-500/50 mb-2 sm:mb-3"
                      >
                        <HiChartBar className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                      </motion.div>
                      <p className="text-[10px] sm:text-xs md:text-sm font-medium text-white/70 mb-1 sm:mb-1.5">Active Users</p>
                      <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-amber-300 to-orange-300 bg-clip-text text-transparent leading-tight">
